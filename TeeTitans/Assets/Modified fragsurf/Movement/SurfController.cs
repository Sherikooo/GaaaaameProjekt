    ...
    public class SurfController {
        ...
        public void ProcessMovement (ISurfControllable surfer, MovementConfig config, float deltaTime) {
            ...
            _deltaTime = deltaTime;
                ...
                // resetMaxJumps & AutoBhop (No clue why its here I dont advise moving it) 
                if(CheckGrounded ()){
                     if (Input.GetButton ("Jump")){
                     _surfer.moveData.wishJump = true;
                 }   
                    _surfer.moveData.jumpsLeft=_config.maxJumps;
                }
        ...
        private void CalculateMovementVelocity () {
                if (_surfer.groundObject == null) {
                    ...
                    */
                    ...
                    // Jump and friction
                    if (_surfer.moveData.wishJump && _surfer.moveData.jumpsLeft>0) {
                        _surfer.moveData.jumpsLeft-=1;
